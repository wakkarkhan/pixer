			...
			<div class="d-flex flex-column flex-lg-row flex-column-fluid">
						...
						<div class="w-lg-500px p-10">
                            ...
                            @csrf
								...
								<div class="text-center mb-11">
									...
									<!--end::Title-->
									<!--begin::Subtitle-->
									<div class="text-gray-500 fw-semibold fs-6">Please Provide Username & Password</div>
									<!--end::Subtitle=-->
								</div>
                                @if ($errors->any())
                                    @foreach ($errors->all() as $error)
								<div class="separator separator-content my-14">
									<span class="fw-semibold fs-7">{{$error}}</span>
								</div>
                                @endforeach
				...
				<div class="d-flex flex-lg-row-fluid w-lg-50 bgi-size-cover bgi-position-center order-1 order-lg-2" style="background-image: url(/media/misc/auth-bg.png)">
					...
					<div class="d-flex flex-column flex-center py-7 py-lg-15 px-5 px-md-15 w-100">
						<!--begin::Logo-->
						<a href="../../demo3/dist/index.html" class="mb-0 mb-lg-12">
