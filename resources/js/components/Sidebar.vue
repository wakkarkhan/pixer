<template>
    <div id="kt_aside" class="aside py-9" data-kt-drawer="true" data-kt-drawer-name="aside" data-kt-drawer-activate="{default: true, lg: false}" data-kt-drawer-overlay="true" data-kt-drawer-width="{default:'200px', '300px': '250px'}" data-kt-drawer-direction="start" data-kt-drawer-toggle="#kt_aside_toggle">
					...
					<div class="aside-logo flex-column-auto px-9 mb-9" id="kt_aside_logo">
						<!--begin::Logo-->
						<router-link to="/home">
							<img alt="Logo" src="/media/logos/demo3.svg" class="h-20px logo theme-light-show" />
							<img alt="Logo" src="/media/logos/demo3-dark.svg" class="h-20px logo theme-dark-show" />
                        </router-link>
						<!--end::Logo-->
					</div>
					<!--end::Brand-->
							...
							<div class="menu menu-column menu-rounded menu-sub-indention menu-active-bg fw-semibold my-auto" id="#kt_aside_menu" data-kt-menu="true">
								...
								<div data-kt-menu-trigger="click" class="menu-item here show menu-accordion">
									...
									<div class="menu-sub menu-sub-accordion">
										...
										<div class="menu-item">
											<!--begin:Menu link-->
                                            <router-link to="/myfirstpage" class="menu-link"><span class="menu-bullet">
													<span class="bullet bullet-dot"></span>
												</span>
												<span class="menu-title">Default</span></router-link>
					...
					<div class="aside-footer flex-column-auto px-9" id="kt_aside_footer">
						...
						<div class="d-flex flex-stack">
							...
							<div class="d-flex align-items-center">
								...
								<div class="ms-2">
									<!--begin::Name-->
									<a href="#" class="text-gray-800 text-hover-primary fs-6 fw-bold lh-1">{{ username }}</a>
									<!--end::Name-->
									<!--begin::Major-->
									<span class="text-muted fw-semibold d-block fs-7 lh-1">abc</span>
									<!--end::Major-->
								</div>
								<!--end::User info-->
							</div>
							...
							<div class="ms-1">
								...
								<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold py-4 fs-6 w-275px" data-kt-menu="true">
									...
									<!--begin::Menu item-->
									<div class="menu-item px-5">
										<a href="l" class="menu-link px-5">My Statements</a>
									</div>
									<!--end::Menu item-->
									<!--begin::Menu separator-->
									<div class="separator my-2"></div>
									...
									<!--begin::Menu item-->
									<div class="menu-item px-5">
                                        <a @click.prevent="logout" class="menu-link px-5">Logout</a>
...
<script>
    ...
    export default  {
        ...
        async created(){
            const res = await this.callApi('get', '/getuser')
		if(res.status==200){
