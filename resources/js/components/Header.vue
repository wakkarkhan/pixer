    ...
    <div id="kt_header" class="header">
						...
						<div class="container d-flex flex-stack flex-wrap gap-2" id="kt_header_container">
							...
							<div class="page-title d-flex flex-column align-items-start justify-content-center flex-wrap me-lg-2 pb-5 pb-lg-0" data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', lg: '#kt_header_container'}">
								<!--begin::Heading-->
								<h1 class="d-flex flex-column text-dark fw-bold my-0 fs-1">eCommerce Dashboard</h1>
								<!--end::Heading-->
							</div>
							<!--end::Page title=-->
							<!--begin::Wrapper-->
							<div class="d-flex d-lg-none align-items-center ms-n2 me-2">
								...
								<router-link to="/home" class="d-flex align-items-center">
									<img alt="Logo" src="media/logos/demo3.svg" class="theme-light-show h-20px" />
									<img alt="Logo" src="media/logos/demo3-dark.svg" class="theme-dark-show h-20px" />
								</router-link>
								<!--end::Logo-->
							</div>
							<!--end::Wrapper-->
